...
<!-- قائمة الجوال -->
<div id="menu"
     class="fixed top-0 left-0 w-3/4 h-full p-6 bg-black text-white shadow-lg z-30 hidden flex-col gap-6 items-start justify-start pt-10 lg:hidden overflow-y-auto transition-transform transform -translate-x-full">
    ...
    <a href="{{route('decor')}}" class="nav-link">صور الديكورات</a>
    ...
    <a href="{{route('coin')}}" class="nav-link">العملات العالمية</a>
...
<style>
    ...
    #menu .nav-link {
        @apply block py-2 text-lg font-bold transition-all duration-300;
    }
