...
<div id="menu"
     class="fixed top-0 left-0 w-full h-screen p-6 bg-black text-white shadow-lg z-30 hidden flex-col gap-6 items-center justify-start pt-10 lg:hidden overflow-y-auto">
    <div>
