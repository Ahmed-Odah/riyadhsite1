...
@section('content')
    ...
    <div class="p-6">
        <!-- زر إضافة صورة جديدة -->
        <div class="mb-6">
            <a href="{{ route('livingroom-create-view') }}"
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-right border border-gray-300 align-middle">
                            <div class="flex gap-2 justify-end">
                                ...
                                <form action="{{ route('livingroom-edit-view', $livingroom->id) }}" method="GET">
                                    <button type="submit"
                        ...
                        <!-- تاريخ الإنشاء -->
                        <td class="px-4 py-3 text-right border border-gray-300 align-middle">
                            {{ $livingroom->created_at->format('Y-m-d') }}
                        </td>
                        ...
                        <td class="px-4 py-3 text-right border border-gray-300 align-middle whitespace-normal break-words">
                            {{ Str::limit($livingroom->description, 80) }}
                        </td>
