...
@section('content')
    <div class="max-w-2xl mx-auto mt-10 bg-white p-6 rounded shadow text-right">
        ...
        <form action="{{ route('Create.PhotoBlackAndWhite') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-6">
                ...
                <input dir="rtl" type="file" id="images" name="images[]" accept="image/*" multiple
