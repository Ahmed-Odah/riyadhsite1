    ...
    <div class="max-w-2xl mx-auto mt-10 bg-white p-6 rounded shadow text-right">
        ...
        <form action="{{ route('house-update', $house->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input dir="rtl" value="{{ $house->title }}" type="text" id="title" name="title"
            ...
            @if($house->cover_url)
                <div class="mb-2">
                    ...
                    <a href="{{ asset('storage/' . $house->cover_url) }}" target="_blank" class="text-blue-600 underline">عرض الملف</a>
                </div>
            @endif
            ...
            @if($house->image)
                <div class="mb-2">
                    ...
                    <img src="{{ asset('public/storage/' . $house->image) }}" class="h-24 rounded">
                </div>
            @endif
