...
@section('content')
    <div class="p-6 space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <!-- عملاء هذا الشهر -->
            <div class="bg-gradient-to-tr from-purple-800 to-purple-500 text-black rounded-2xl shadow-xl p-6 flex items-center justify-between transform hover:scale-105 hover:shadow-2xl transition duration-300 contrast-125 saturate-150 text-ceenter">
                <div>
