...
@section('content')
    <div class="p-6 space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <!-- عدد العملاء -->
            <div class="bg-gradient-to-tr from-green-700 to-green-500 text-black rounded-2xl shadow-xl p-6 flex items-center justify-between transform hover:scale-105 hover:shadow-2xl transition duration-300 contrast-125 saturate-150">
                <div>
